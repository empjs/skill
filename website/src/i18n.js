...
const translations = {
  en: {
    ...
    hero: {
      ...
      description: 'Write once, distribute to all agents. Manage skills for Claude Code, Cursor, Windsurf and more through a unified CLI.',
    ...
    features: {
      ...
      mainDesc: 'Comprehensive skill management at your fingertips. Install, distribute, and manage skills across all AI agents with one CLI.',
      title: 'Features',
      unified: {
